...
public class Pickup extends SubsystemBase {
    ...
    public Pickup() {
        ...
        pickupMotorKraken.getConfigurator().apply(configs);
        pickupMotorKraken.getConfigurator().apply(Constants.PICKUP_CURRENT_LIMITS);
        configs.Inverted = InvertedValue.CounterClockwise_Positive;
        rotationMotor.getConfigurator().apply(configs);
        rotationMotor.getConfigurator().apply(Constants.PICKUP_ROTATION_CURRENT_LIMITS);
