...
public class Constants {
    ...
    public static final CurrentLimitsConfigs DELIVERY_CURRENT_LIMITS =
            new CurrentLimitsConfigs()
                    .withSupplyCurrentLimit(30)
                    .withSupplyCurrentLimitEnable(true);
    public static final CurrentLimitsConfigs PICKUP_CURRENT_LIMITS =
            new CurrentLimitsConfigs()
                    .withSupplyCurrentLimit(30)
                    .withSupplyCurrentLimitEnable(true);
    public static final CurrentLimitsConfigs PICKUP_ROTATION_CURRENT_LIMITS =
            new CurrentLimitsConfigs()
                    .withSupplyCurrentLimit(30)
                    .withSupplyCurrentLimitEnable(true);
    ...
    public static class Pickup {
        ...
        public static double RAISED_SETPOINT = 1;
